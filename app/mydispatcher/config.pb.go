...
var file_app_mydispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: ecycloudnode.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: ecycloudnode.app.mydispatcher.Config
}
var file_app_mydispatcher_config_proto_depIdxs = []int32{
	0, // 0: ecycloudnode.app.mydispatcher.Config.settings:type_name -> ecycloudnode.app.mydispatcher.SessionConfig
